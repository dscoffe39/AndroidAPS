...
class HardLimitsImpl @Inject constructor(
    ...
    companion object {
        ...
        private val MAX_BOLUS = doubleArrayOf(5.0, 10.0, 19.0, 25.0, 60.0)
        ...
        val MAX_IOB_AMA = doubleArrayOf(3.0, 5.0, 17.0, 12.0, 25.0)
        val MAX_IOB_SMB = doubleArrayOf(7.0, 13.0, 22.0, 30.0, 70.0)
        val MAX_BASAL = doubleArrayOf(2.0, 5.0, 11.0, 12.0, 25.0)
